...
{
    public class PaymentDetailDetailsMapper : Profile
    {
        public PaymentDetailDetailsMapper()
        {
            CreateMap<CreatePaymentDetailsRequest, PaymentDetail>().ReverseMap();
            CreateMap<GetPaymentDetailResponse, PaymentDetail>().ReverseMap();
        }
    }
}
